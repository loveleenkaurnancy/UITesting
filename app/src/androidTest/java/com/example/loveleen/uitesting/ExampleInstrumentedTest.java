...
public class ExampleInstrumentedTest {
    ...
    public static final String USERNAME_TYPED = "PK";

    public static final String LOGIN_TEXT = "Hello PK";
    ...
    public void useAppContext() {
        ...
        assertEquals("com.example.loveleen.uitesting", appContext.getPackageName());
    }
